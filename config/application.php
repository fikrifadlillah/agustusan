...
require_once __DIR__ .'/../model/modelAcara.php';
require_once __DIR__ .'/../model/modelPenerimaan.php';
require_once __DIR__ .'/../model/modelPengeluaran.php';
// ====================================================
...
$acara    	 = new modelAcara();
$penerimaan	 = new modelPenerimaan();
$pengeluaran	 = new modelPengeluaran();
// ====================================================
