  ...
  <div class="wrapper">
    <header class="main-header">
      <a href="index2.html" class="logo">
        <span class="logo-mini"><img src="<?php echo $url_rewrite;?>static/dist/img/"></span>
        <span class="logo-lg"><img src="<?php echo $url_rewrite;?>static/dist/img/"></span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo $url_rewrite;?>static/dist/img/" class="user-image" alt="User Image">
