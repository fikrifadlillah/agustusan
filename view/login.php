...
<html>
  <head>
    ...
    <title>SI KEPANITIAAN HUT RI RI KARTUN RW 20</title>
  ...
  <body class="hold-transition login-page">
      ...
      <div class="top-header">
        <div class="container">
          <a href="#">
            ...
            <h3 class="logo nomargin">Sistem Informasi Kepanitiaan HUT RI - 71</h3>
    ...
    <div class="login-box">
      ...
      <?php include "view/include/alert.php" ?>
        ...
        <p class="nomargin" style="margin-top:8px"><a href="<?php echo $url_rewrite;?>content/registrasi">Registrasi User Baru</a></p>
      </div>
    </div>
